...
const Timeline = () => {
  ...
  return (
    <div className='relative grid grid-cols-1 md:grid-cols-2 gap-x-2 md:gap-x-14 gap-4 md:gap-y-7 mx-auto w-full md:w-5/6 my-8 bg-white bg-opacity-90 p-4 md:p-10'>
